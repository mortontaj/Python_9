...
class Album:
    ...
    Attribute:
        name (str): The title of a song to add.
        year (int): The year the album was released.
        artist: (str): The name of the artist responsible for the album. If not specified,
        the artist will default to the artist with the name "Various Artists".
        tracks: (List[song]): A list of the songs on the album.

    Method:
        add_song: Used to add a new sng to the album's track list.
    """
...
def create_checkfile(artist_list):
    """Create a check file from the object for comparison with the original file"""
